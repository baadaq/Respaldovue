<template>
    <div class="surface-100 border-solid border-round-xl pt-2 pl-2">
      <div >
        ...
        :globalFilterFields="['Codigo_Item','Usuario']" responsiveLayout="scroll">
        <template #header >
                  <div class="table-header flex flex-column md:flex-row md:justiify-content-between">
                      <h5 class="mb-2 md:m-0 p-as-md-center ">Entregas No Concluidas</h5>
        ...
        <Column field="Id" header="Id Request" ></Column>
      ...
      <div>
        <Dialog v-model:visible="Details"  header="Detalle del pedido" :modal="true" :style="{minWidth:'50em'}" :content-style="{minHeight:'30em'}" class="p-fluid min-height:100px;">
...
export default {
  setup() {
    ...
    onMounted(()=>{
      ...
      RequestService.getrequestAlmost(configuration).then(response => 
    ...
    return {requestList, Filtros, headers,headersItems,
        exportCSV,moment, requestDetail,dt,//Datos precargados
            Details, openDialog,closeDialog//Datos precargados
